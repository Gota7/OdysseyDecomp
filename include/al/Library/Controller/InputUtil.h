...
namespace al {
    int getJoyPadSingleRightPort(void);
    int getJoyPadSingleLeftPort(void);
    int getJoyPadDoublePort(void);
    int getTouchPanelPort(void);
    int getMainControllerPort(void);
    int getPlayerControllerPort(int);
    int getMainJoyPadDoublePort(void);
    int getMainJoyPadSingleRightPort(void);
    int getMainJoyPadSingleLeftPort(void);
    bool isSameNpadId(unsigned int, int);
    ...
    void getPadCrossDir(sead::Vector2<float> *, int);
    void getPadCrossDirSideways(sead::Vector2<float> *, int);
    void calcTouchScreenPos(sead::Vector2<float> *);
    void calcTouchLayoutPos(sead::Vector2<float> *);
    bool isTouchPosInRect(sead::Vector2<float> const &, sead::Vector2<float> const &);
    bool isTouchPosInCircle(sead::Vector2<float> const &, float);
    bool isTouchPosInCircleByWorldPos(sead::Vector3<float> const &, al::IUseCamera const *, float, float);
    bool isPadTouchRect(float, float, float, float);
    bool isPadTriggerUiCursorUp(int);
    bool isPadTriggerUiCursorDown(int);
    bool isPadTriggerUiCursorLeft(int);
    bool isPadTriggerUiCursorRight(int);
    bool isPadRepeatUiCursorUp(int);
    ...
    bool isPadReleaseUiCursorUp(int);
    ...
    bool tryGetPadAcceleration(sead::Vector3<float> *, int, int);
    bool isPadConnected(int);
    bool isShakePadAcceleration(float, int, int);
    bool isPadEnableLeftStick(int);
    bool isPadEnableRightStick(int);
    bool isPadExistDeviceSpeaker(int);
    int getPadIdleFrame(int);
    /*
    void tryGetPortFirstConnected(int const *, int);
    void isPadConnectedJoyPadDouble(void);
    void getPadPoseDeviceNum(int);
    void tryGetPadPose(sead::Vector3<float> *, sead::Vector3<float> *, sead::Vector3<float> *, int, int);
    void getPadPose(sead::Vector3<float> *, sead::Vector3<float> *, sead::Vector3<float> *, int, int);
    void getPadPoseMtx(sead::Matrix33<float> *, int, int);
    void getPadPoseRadian(sead::Vector3<float> *, int, int);
    void getPadAngularVelocity(sead::Vector3<float> *, int, int);
    void getPadPoseMainJoySingleLeft(sead::Vector3<float> *, sead::Vector3<float> *, sead::Vector3<float> *);
    void getPadPoseMainJoySingleRight(sead::Vector3<float> *, sead::Vector3<float> *, sead::Vector3<float> *);
    */
    void resetPadPose(int);
    void resetPadAutoSleepTimeCount(int);
    bool isPadTypeJoySingle(int);
    bool isPadTypeJoyDual(int);
    bool isPadTypeJoyLeft(int);
    bool isPadTypeJoyRight(int);
    bool isPadTypeHandheld(int);
    bool isPadTypeFullKey(int);
    bool tryGetPadColor(sead::Color4f *, sead::Color4f *, sead::Color4f *, sead::Color4f *, int);
