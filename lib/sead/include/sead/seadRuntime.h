...
namespace sead {
    namespace RuntimeTypeInfo {
        ...
        public:
            ...
            virtual bool isDerived(const Interface *pTypeInfo) const = 0;
        };
        ...
        public:
            ...
            bool isDerived(const Interface *pTypeInfo) const override {
                return pTypeInfo == this;
            }
        };
        ...
        public:
            ...
            bool isDerived(const Interface *pTypeInfo) const override {
                ...
                const Interface* interface = Base::getRuntimeTypeInfoStatic();
                return interface->isDerived(pTypeInfo);
            }
        };
    };
};
