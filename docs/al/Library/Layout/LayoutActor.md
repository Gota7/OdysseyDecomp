...
| `_ZN2al12MoveTwoPoint4initERKNS_13ActorInitInfoE` | `al::MoveTwoPoint::init(al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZNK2al12MoveTwoPoint8calcPoseEPN4sead4QuatIfEEPNS1_7Vector3IfEEf` | `al::MoveTwoPoint::calcPose(sead::Quat<float> *,sead::Vector3<float> *,float)const` | :white_check_mark: |
| `_ZNK2al12MoveTwoPoint18calcPoseByDistanceEPN4sead4QuatIfEEPNS1_7Vector3IfEEf` | `al::MoveTwoPoint::calcPoseByDistance(sead::Quat<float> *,sead::Vector3<float> *,float)const` | :white_check_mark: |
| `_ZN2al11startActionEPNS_16IUseLayoutActionEPKcS3_` | `al::startAction(al::IUseLayoutAction *,char const*,char const*)` | :white_check_mark: |
| `_ZN2al24startActionAtRandomFrameEPNS_16IUseLayoutActionEPKcS3_` | `al::startActionAtRandomFrame(al::IUseLayoutAction *,char const*,char const*)` | :white_check_mark: |
| `_ZN2al17startFreezeActionEPNS_16IUseLayoutActionEPKcfS3_` | `al::startFreezeAction(al::IUseLayoutAction *,char const*,float,char const*)` | :white_check_mark: |
| `_ZN2al20startFreezeActionEndEPNS_16IUseLayoutActionEPKcS3_` | `al::startFreezeActionEnd(al::IUseLayoutAction *,char const*,char const*)` | :white_check_mark: |
| `_ZN2al17getActionFrameMaxEPKNS_16IUseLayoutActionEPKcS4_` | `al::getActionFrameMax(al::IUseLayoutAction const*,char const*,char const*)` | :white_check_mark: |
| `_ZN2al22startFreezeGaugeActionEPNS_16IUseLayoutActionEfffPKcS3_` | `al::startFreezeGaugeAction(al::IUseLayoutAction *,float,float,float,char const*,char const*)` | :white_check_mark: |
| `_ZN2al14tryStartActionEPNS_16IUseLayoutActionEPKcS3_` | `al::tryStartAction(al::IUseLayoutAction *,char const*,char const*)` | :white_check_mark: |
| `_ZN2al13isExistActionEPKNS_16IUseLayoutActionEPKcS4_` | `al::isExistAction(al::IUseLayoutAction const*,char const*,char const*)` | :white_check_mark: |
| `_ZN2al11isActionEndEPKNS_16IUseLayoutActionEPKc` | `al::isActionEnd(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al13isExistActionEPKNS_16IUseLayoutActionEPKc` | `al::isExistAction(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al15isActionOneTimeEPKNS_16IUseLayoutActionEPKcS4_` | `al::isActionOneTime(al::IUseLayoutAction const*,char const*,char const*)` | :white_check_mark: |
| `_ZN2al14getActionFrameEPKNS_16IUseLayoutActionEPKc` | `al::getActionFrame(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al14setActionFrameEPNS_16IUseLayoutActionEfPKc` | `al::setActionFrame(al::IUseLayoutAction *,float,char const*)` | :white_check_mark: |
| `_ZN2al18getActionFrameRateEPKNS_16IUseLayoutActionEPKc` | `al::getActionFrameRate(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al18setActionFrameRateEPNS_16IUseLayoutActionEfPKc` | `al::setActionFrameRate(al::IUseLayoutAction *,float,char const*)` | :white_check_mark: |
| `_ZN2al13getActionNameEPKNS_16IUseLayoutActionEPKc` | `al::getActionName(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al15isActionPlayingEPKNS_16IUseLayoutActionEPKcS4_` | `al::isActionPlaying(al::IUseLayoutAction const*,char const*,char const*)` | :white_check_mark: |
| `_ZN2al18isAnyActionPlayingEPKNS_16IUseLayoutActionEPKc` | `al::isAnyActionPlaying(al::IUseLayoutAction const*,char const*)` | :white_check_mark: |
| `_ZN2al19setNerveAtActionEndEPNS_11LayoutActorEPKNS_5NerveE` | `al::setNerveAtActionEnd(al::LayoutActor *,al::Nerve const*)` | :white_check_mark: |
| `_ZN2al17startTextPaneAnimEPNS_11LayoutActorEPKDsPKNS_20MessageTagDataHolderEPKNS_23ReplaceTagProcessorBaseE` | `al::startTextPaneAnim(al::LayoutActor *,char16_t const*,al::MessageTagDataHolder const*,al::ReplaceTagProcessorBase const*)` | :white_check_mark: |
| `_ZN2al30startTextPaneAnimWithAudioUserEPNS_11LayoutActorEPKDsPKNS_20MessageTagDataHolderEPKNS_23ReplaceTagProcessorBaseEPKNS_15IUseAudioKeeperE` | `al::startTextPaneAnimWithAudioUser(al::LayoutActor *,char16_t const*,al::MessageTagDataHolder const*,al::ReplaceTagProcessorBase const*,al::IUseAudioKeeper const*)` | :white_check_mark: |
| `_ZN2al28startAndSetTextPaneAnimStageEPNS_11LayoutActorEPKcS3_PKNS_20MessageTagDataHolderEPKNS_23ReplaceTagProcessorBaseE` | `al::startAndSetTextPaneAnimStage(al::LayoutActor *,char const*,char const*,al::MessageTagDataHolder const*,al::ReplaceTagProcessorBase const*)` | :white_check_mark: |
| `_ZN2al29startAndSetTextPaneAnimSystemEPNS_11LayoutActorEPKcS3_PKNS_20MessageTagDataHolderEPKNS_23ReplaceTagProcessorBaseE` | `al::startAndSetTextPaneAnimSystem(al::LayoutActor *,char const*,char const*,al::MessageTagDataHolder const*,al::ReplaceTagProcessorBase const*)` | :white_check_mark: |
| `_ZN2al15endTextPaneAnimEPNS_11LayoutActorE` | `al::endTextPaneAnim(al::LayoutActor *)` | :white_check_mark: |
| `_ZN2al16skipTextPaneAnimEPNS_11LayoutActorE` | `al::skipTextPaneAnim(al::LayoutActor *)` | :white_check_mark: |
...
| `_ZN2al16LayoutActorGroup13registerActorEPNS_11LayoutActorE` | `al::LayoutActorGroup::registerActor(al::LayoutActor *)` | :white_check_mark: |
...
| `_ZN2al8hidePaneEPNS_10IUseLayoutEPKc` | `al::hidePane(al::IUseLayout *,char const*)` | :white_check_mark: |
...
| `_ZN2al19setPaneNumberDigit3EPNS_10IUseLayoutEPKcit` | `al::setPaneNumberDigit3(al::IUseLayout *,char const*,int,unsigned short)` | :white_check_mark: |
