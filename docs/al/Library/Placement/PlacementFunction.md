...
| ------------- |  ------------- | ------------- |
| `_ZN2al11isValidInfoERKNS_13PlacementInfoE` | `al::isValidInfo(al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al8isPlacedERKNS_13ActorInitInfoE` | `al::isPlaced(al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al13getObjectNameEPPKcRKNS_13ActorInitInfoE` | `al::getObjectName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al13getObjectNameEPPKcRKNS_13PlacementInfoE` | `al::getObjectName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al16tryGetObjectNameEPPKcRKNS_13PlacementInfoE` | `al::tryGetObjectName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al16tryGetObjectNameEPPKcRKNS_13ActorInitInfoE` | `al::tryGetObjectName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al15tryGetStringArgEPPKcRKNS_13PlacementInfoES1_` | `al::tryGetStringArg(char const**,al::PlacementInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al12isObjectNameERKNS_13ActorInitInfoEPKc` | `al::isObjectName(al::ActorInitInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al12isObjectNameERKNS_13PlacementInfoEPKc` | `al::isObjectName(al::PlacementInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al18isObjectNameSubStrERKNS_13ActorInitInfoEPKc` | `al::isObjectNameSubStr(al::ActorInitInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al18isObjectNameSubStrERKNS_13PlacementInfoEPKc` | `al::isObjectNameSubStr(al::PlacementInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al15tryGetClassNameEPPKcRKNS_13ActorInitInfoE` | `al::tryGetClassName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al15tryGetClassNameEPPKcRKNS_13PlacementInfoE` | `al::tryGetClassName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al24tryGetPlacementInfoByKeyEPNS_13PlacementInfoERKS0_PKc` | `al::tryGetPlacementInfoByKey(al::PlacementInfo *,al::PlacementInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al12getClassNameEPPKcRKNS_13ActorInitInfoE` | `al::getClassName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al12getClassNameEPPKcRKNS_13PlacementInfoE` | `al::getClassName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al11isClassNameERKNS_13ActorInitInfoEPKc` | `al::isClassName(al::ActorInitInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al11isClassNameERKNS_13PlacementInfoEPKc` | `al::isClassName(al::PlacementInfo const&,char const*)` | :white_check_mark: |
| `_ZN2al14getDisplayNameEPPKcRKNS_13ActorInitInfoE` | `al::getDisplayName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al17tryGetDisplayNameEPPKcRKNS_13ActorInitInfoE` | `al::tryGetDisplayName(char const**,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al14getDisplayNameEPPKcRKNS_13PlacementInfoE` | `al::getDisplayName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al17tryGetDisplayNameEPPKcRKNS_13PlacementInfoE` | `al::tryGetDisplayName(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al22getPlacementTargetFileEPPKcRKNS_13PlacementInfoE` | `al::getPlacementTargetFile(char const**,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al11tryGetTransEPN4sead7Vector3IfEERKNS_13ActorInitInfoE` | `al::tryGetTrans(sead::Vector3<float> *,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al11tryGetTransEPN4sead7Vector3IfEERKNS_13PlacementInfoE` | `al::tryGetTrans(sead::Vector3<float> *,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al11multZoneMtxEPN4sead7Vector3IfEERKNS_13PlacementInfoE` | `al::multZoneMtx(sead::Vector3<float> *,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al8getTransEPN4sead7Vector3IfEERKNS_13PlacementInfoE` | `al::getTrans(sead::Vector3<float> *,al::PlacementInfo const&)` | :white_check_mark: |
| `_ZN2al8getTransEPN4sead7Vector3IfEERKNS_13ActorInitInfoE` | `al::getTrans(sead::Vector3<float> *,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al12tryGetRotateEPN4sead7Vector3IfEERKNS_13ActorInitInfoE` | `al::tryGetRotate(sead::Vector3<float> *,al::ActorInitInfo const&)` | :white_check_mark: |
| `_ZN2al12tryGetRotateEPN4sead7Vector3IfEERKNS_13PlacementInfoE` | `al::tryGetRotate(sead::Vector3<float> *,al::PlacementInfo const&)` | :white_check_mark: |
...
| `_ZN2al9tryGetArgEPfRKNS_13ActorInitInfoEPKc` | `al::tryGetArg(float *,al::ActorInitInfo const&,char const*)` | :white_check_mark: |
...
| `_ZN2al21getCountPlacementInfoERKNS_13PlacementInfoE` | `al::getCountPlacementInfo(al::PlacementInfo const&)` | :white_check_mark: |
...
| `_ZN2al21getLinksMatrixByIndexEPN4sead8Matrix34IfEERKNS_13ActorInitInfoEPKci` | `al::getLinksMatrixByIndex(sead::Matrix34<float> *,al::ActorInitInfo const&,char const*,int)` | :white_check_mark: |
...
| `_ZN19alPlacementFunction18getClippingGroupIdEPN2al11PlacementIdERKNS0_13ActorInitInfoE` | `alPlacementFunction::getClippingGroupId(al::PlacementId *,al::ActorInitInfo const&)` | :white_check_mark: |
