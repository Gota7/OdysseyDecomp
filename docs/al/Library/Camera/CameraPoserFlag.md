...
| `_ZNK2al15CameraPoserFlag32isValidKeepPreSelfPoseNextCameraEv` | `al::CameraPoserFlag::isValidKeepPreSelfPoseNextCamera(void)const` | :white_check_mark: |
| `_ZN21alCameraPoserFunction12getViewIndexEPKN2al11CameraPoserE` | `alCameraPoserFunction::getViewIndex(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction15getLookAtCameraEPKN2al11CameraPoserE` | `alCameraPoserFunction::getLookAtCamera(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction17getProjectionSeadEPKN2al11CameraPoserE` | `alCameraPoserFunction::getProjectionSead(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction13getProjectionEPKN2al11CameraPoserE` | `alCameraPoserFunction::getProjection(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction16getProjectionMtxEPKN2al11CameraPoserE` | `alCameraPoserFunction::getProjectionMtx(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction7getNearEPKN2al11CameraPoserE` | `alCameraPoserFunction::getNear(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction6getFarEPKN2al11CameraPoserE` | `alCameraPoserFunction::getFar(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction9getAspectEPKN2al11CameraPoserE` | `alCameraPoserFunction::getAspect(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction15getPreCameraPosEPKN2al11CameraPoserE` | `alCameraPoserFunction::getPreCameraPos(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction15getPreLookAtPosEPKN2al11CameraPoserE` | `alCameraPoserFunction::getPreLookAtPos(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction11getPreUpDirEPKN2al11CameraPoserE` | `alCameraPoserFunction::getPreUpDir(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction16getPreFovyDegreeEPKN2al11CameraPoserE` | `alCameraPoserFunction::getPreFovyDegree(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction16getPreFovyRadianEPKN2al11CameraPoserE` | `alCameraPoserFunction::getPreFovyRadian(al::CameraPoser const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction17isPrePriorityDemoERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityDemo(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction18isPrePriorityDemo2ERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityDemo2(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction21isPrePriorityDemoTalkERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityDemoTalk(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction20isPrePriorityDemoAllERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityDemoAll(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction24isPrePriorityEntranceAllERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityEntranceAll(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction19isPrePriorityPlayerERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPrePriorityPlayer(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction20isEqualPreCameraNameERKN2al15CameraStartInfoEPKc` | `alCameraPoserFunction::isEqualPreCameraName(al::CameraStartInfo const&,char const*)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction22isPreCameraFixAbsoluteERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isPreCameraFixAbsolute(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction25isInvalidCollidePreCameraERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isInvalidCollidePreCamera(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction30isInvalidKeepPreCameraDistanceERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isInvalidKeepPreCameraDistance(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction41isInvalidKeepPreCameraDistanceIfNoCollideERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isInvalidKeepPreCameraDistanceIfNoCollide(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction25isValidResetPreCameraPoseERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isValidResetPreCameraPose(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction28isValidKeepPreSelfCameraPoseERKN2al15CameraStartInfoE` | `alCameraPoserFunction::isValidKeepPreSelfCameraPose(al::CameraStartInfo const&)` | :white_check_mark: |
| `_ZN21alCameraPoserFunction23getPreCameraSwingAngleHERKN2al15CameraStartInfoE` | `alCameraPoserFunction::getPreCameraSwingAngleH(al::CameraStartInfo const&)` | :white_check_mark: |
...
| `_ZN21alCameraPoserFunction12calcTargetUpEPN4sead7Vector3IfEEPKN2al11CameraPoserE` | `alCameraPoserFunction::calcTargetUp(sead::Vector3<float> *,al::CameraPoser const*)` | :white_check_mark: |
...
| `_ZN21alCameraPoserFunction21isValidSubTargetTurnVEPKN2al11CameraPoserE` | `alCameraPoserFunction::isValidSubTargetTurnV(al::CameraPoser const*)` | :white_check_mark: |
...
| `_ZN21alCameraPoserFunction13getGyroAngleVEPN2al11CameraPoserE` | `alCameraPoserFunction::getGyroAngleV(al::CameraPoser *)` | :white_check_mark: |
...
| `_ZN21alCameraPoserFunction20isRequestResetAngleVERKN2al23CameraObjectRequestInfoE` | `alCameraPoserFunction::isRequestResetAngleV(al::CameraObjectRequestInfo const&)` | :white_check_mark: |
...
| `_ZN21alCameraPoserFunction14multVecInvZoneEPN4sead7Vector3IfEERKS2_PKN2al11CameraPoserE` | `alCameraPoserFunction::multVecInvZone(sead::Vector3<float> *,sead::Vector3<float> const&,al::CameraPoser const*)` | :white_check_mark: |
