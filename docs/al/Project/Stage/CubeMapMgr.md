...
| `_ZN3agl3env26CubeMapFilterImportanceGGXD0Ev` | `agl::env::CubeMapFilterImportanceGGX::~CubeMapFilterImportanceGGX()` | :white_check_mark: |
| `_ZN3agl3env26CubeMapFilterImportanceGGX7calcGPUERKN4sead7Vector3IfEE` | `agl::env::CubeMapFilterImportanceGGX::calcGPU(sead::Vector3<float> const&)` | :white_check_mark: |
| `_ZNK3agl3env26CubeMapFilterImportanceGGX14generateMipMapEPNS_11DrawContextERKNS_11TextureDataE` | `agl::env::CubeMapFilterImportanceGGX::generateMipMap(agl::DrawContext *,agl::TextureData const&)const` | :white_check_mark: |
| `_ZNK3agl3env26CubeMapFilterImportanceGGX13drawGGXFilterEPNS_11DrawContextERKNS_11TextureDataEb` | `agl::env::CubeMapFilterImportanceGGX::drawGGXFilter(agl::DrawContext *,agl::TextureData const&,bool)const` | :white_check_mark: |
| `_ZN3agl3env26CubeMapFilterImportanceGGX10genMessageEPN4sead6hostio7ContextE` | `agl::env::CubeMapFilterImportanceGGX::genMessage(sead::hostio::Context *)` | :white_check_mark: |
| `_ZN3agl3env26CubeMapFilterImportanceGGX19listenPropertyEventEPKN4sead6hostio13PropertyEventE` | `agl::env::CubeMapFilterImportanceGGX::listenPropertyEvent(sead::hostio::PropertyEvent const*)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgentC2Ev` | `al::CubeMapMgr::UpdateAgent::UpdateAgent(void)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgentD2Ev` | `al::CubeMapMgr::UpdateAgent::~UpdateAgent()` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent5setupEPNS0_11CreatorUnitES3_PNS0_12ReservedUnitEjPKS0_` | `al::CubeMapMgr::UpdateAgent::setup(al::CubeMapMgr::CreatorUnit *,al::CubeMapMgr::CreatorUnit *,al::CubeMapMgr::ReservedUnit *,unsigned int,al::CubeMapMgr const*)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent9terminateEv` | `al::CubeMapMgr::UpdateAgent::terminate(void)` | :white_check_mark: |
| `_ZNK2al10CubeMapMgr11UpdateAgent18getRenderBufferPtrEv` | `al::CubeMapMgr::UpdateAgent::getRenderBufferPtr(void)const` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent6updateEv` | `al::CubeMapMgr::UpdateAgent::update(void)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr20getCubeMapProjectionEPN4sead21PerspectiveProjectionEff` | `al::CubeMapMgr::getCubeMapProjection(sead::PerspectiveProjection *,float,float)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr16getCubeMapCameraEPN4sead12DirectCameraEjRKNS1_7Vector3IfEE` | `al::CubeMapMgr::getCubeMapCamera(sead::DirectCamera *,unsigned int,sead::Vector3<float> const&)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent5beginEPN3agl11DrawContextEj` | `al::CubeMapMgr::UpdateAgent::begin(agl::DrawContext *,unsigned int)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent3endEPN3agl11DrawContextE` | `al::CubeMapMgr::UpdateAgent::end(agl::DrawContext *)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11UpdateAgent7backendEPN3agl11DrawContextE` | `al::CubeMapMgr::UpdateAgent::backend(agl::DrawContext *)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11CreatorUnit14generateMipMapEPN3agl11DrawContextEjj` | `al::CubeMapMgr::CreatorUnit::generateMipMap(agl::DrawContext *,unsigned int,unsigned int)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr11CreatorUnit9encodeHDREPN3agl11DrawContextEPNS2_3env7CubeMapEPNS0_12ReservedUnitE` | `al::CubeMapMgr::CreatorUnit::encodeHDR(agl::DrawContext *,agl::env::CubeMap *,al::CubeMapMgr::ReservedUnit *)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit10outputFileEPN3agl11DrawContextERKN4sead14SafeStringBaseIcEENS0_13HDREncodeTypeEb` | `al::CubeMapMgr::Unit::outputFile(agl::DrawContext *,sead::SafeStringBase<char> const&,al::CubeMapMgr::HDREncodeType,bool)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4UnitC2Ev` | `al::CubeMapMgr::Unit::Unit(void)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4UnitD2Ev` | `al::CubeMapMgr::Unit::~Unit()` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4UnitD0Ev` | `al::CubeMapMgr::Unit::~Unit()` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit10initializeEPN4sead4HeapEPS0_` | `al::CubeMapMgr::Unit::initialize(sead::Heap *,al::CubeMapMgr*)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit10initializeEPN4sead4HeapEPS0_N3agl14GPUMemVoidAddrEjS7_j` | `al::CubeMapMgr::Unit::initialize(sead::Heap *,al::CubeMapMgr*,agl::GPUMemVoidAddr,unsigned int,agl::GPUMemVoidAddr,unsigned int)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit10initializeEPN4sead4HeapEPS0_PN3agl3env7CubeMapENS6_14GPUMemVoidAddrEj` | `al::CubeMapMgr::Unit::initialize(sead::Heap *,al::CubeMapMgr*,agl::env::CubeMap *,agl::GPUMemVoidAddr,unsigned int)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit8reformatERKN3agl11TextureDataE` | `al::CubeMapMgr::Unit::reformat(agl::TextureData const&)` | :white_check_mark: |
| `_ZN2al10CubeMapMgr4Unit8reformatEN3agl13TextureFormatEjj` | `al::CubeMapMgr::Unit::reformat(agl::TextureFormat,unsigned int,unsigned int)` | :white_check_mark: |
...
| `_ZN2al10CubeMapMgr12ReservedUnit19listenPropertyEventEPKN4sead6hostio13PropertyEventE` | `al::CubeMapMgr::ReservedUnit::listenPropertyEvent(sead::hostio::PropertyEvent const*)` | :white_check_mark: |
...
| `_ZNK2al10CubeMapMgr21getUnitIlluminantInfoEPNS0_17IlluminantInfoArgEPKNS0_12ReservedUnitEj` | `al::CubeMapMgr::getUnitIlluminantInfo(al::CubeMapMgr::IlluminantInfoArg *,al::CubeMapMgr::ReservedUnit const*,unsigned int)const` | :white_check_mark: |
